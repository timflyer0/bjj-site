...
const coaches = [
    ...
    },
    {
        ...
        lead: '<strong>Чёрный пояс по бразильскому джиу-джитсу (IBJJF)</strong>, 4-й дан и тренер международного уровня с многолетним опытом.',

        achievements: [
            '<strong>10 лет руководил программами BJJ в Abu Dhabi (Palms Sports, Royal Group)</strong> — более 330 центров, 630+ тренеров и 125 000+ учеников.',
            '<strong>6-кратный чемпион Южной Бразилии</strong> и чемпион Великобритании.',
            '<strong>Призёр крупнейших международных турниров IBJJF и UAEJJF</strong>, включая European Championship, World Pro Abu Dhabi и Grand Slam Tokyo.'
        ],

        paragraphs: [
            'Работал с профессиональными спортсменами, государственными структурами, армией, полицией и национальными командами.',
            'Передаёт ученикам <strong>системный подход мирового уровня</strong>, позволяющий быстро расти и выходить на высокий уровень техники.'
        ],
